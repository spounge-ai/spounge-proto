...
const (
	...
	UserService_AddManagedSecret_FullMethodName    = "/user.v1.UserService/AddManagedSecret"
	UserService_ListManagedSecrets_FullMethodName  = "/user.v1.UserService/ListManagedSecrets"
	UserService_GetManagedSecret_FullMethodName    = "/user.v1.UserService/GetManagedSecret"
	UserService_DeleteManagedSecret_FullMethodName = "/user.v1.UserService/DeleteManagedSecret"
)
