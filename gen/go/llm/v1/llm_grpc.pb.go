...
const (
	LLMProviderService_GenerateText_FullMethodName       = "/llm.v1.LLMProviderService/GenerateText"
	LLMProviderService_GenerateTextStream_FullMethodName = "/llm.v1.LLMProviderService/GenerateTextStream"
	LLMProviderService_GenerateEmbedding_FullMethodName  = "/llm.v1.LLMProviderService/GenerateEmbedding"
)
...
type LLMProviderServiceClient interface {
	...
	GenerateTextStream(ctx context.Context, in *GenerateTextRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GenerateTextStreamResponse], error)
...
func (c *lLMProviderServiceClient) GenerateTextStream(ctx context.Context, in *GenerateTextRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GenerateTextStreamResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[GenerateTextRequest, GenerateTextStreamResponse]{ClientStream: stream}
...
type LLMProviderServiceServer interface {
	...
	GenerateTextStream(*GenerateTextRequest, grpc.ServerStreamingServer[GenerateTextStreamResponse]) error
...
func (UnimplementedLLMProviderServiceServer) GenerateTextStream(*GenerateTextRequest, grpc.ServerStreamingServer[GenerateTextStreamResponse]) error {
...
func _LLMProviderService_GenerateTextStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LLMProviderServiceServer).GenerateTextStream(m, &grpc.GenericServerStream[GenerateTextRequest, GenerateTextStreamResponse]{ServerStream: stream})
}
...
var LLMProviderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "llm.v1.LLMProviderService",
