...
func (x *Metadata) Reset() {
	*x = Metadata{}
	mi := &file_common_v2_common_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Metadata) Descriptor() ([]byte, []int) {
	return file_common_v2_common_proto_rawDescGZIP(), []int{5}
}
...
const file_common_v2_common_proto_rawDesc = "" +
	"\n" +
	"\x16common/v2/common.proto\x12\tcommon.v2\x1a\x1cgoogle/protobuf/struct.proto\"i\n" +
	"\x06Status\x12\x12\n" +
...
var (
	...
	file_common_v2_common_proto_rawDescData []byte
)

func file_common_v2_common_proto_rawDescGZIP() []byte {
	file_common_v2_common_proto_rawDescOnce.Do(func() {
		file_common_v2_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_v2_common_proto_rawDesc), len(file_common_v2_common_proto_rawDesc)))
	})
