...
type LoginResponse struct {
	...
	User          *v11.UserProfile       `protobuf:"bytes,3,opt,name=user,proto3" json:"user,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoginResponse) GetUser() *v11.UserProfile {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *RefreshTokenResponse) GetStatus() *v1.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *LogoutResponse) GetStatus() *v1.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_auth_v1_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x1aauth/v1/auth_service.proto\x12\aauth.v1\x1a\x13auth/v1/token.proto\x1a\x16common/v1/common.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x12user/v1/user.proto\"@\n" +
	...
	"\x04user\x18\x03 \x01(\v2\x14.user.v1.UserProfileR\x04user\":\n" +
	"\x13RefreshTokenRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken\"k\n" +
	"\x14RefreshTokenResponse\x12)\n" +
	"\x06status\x18\x01 \x01(\v2\x11.common.v1.StatusR\x06status\x12(\n" +
	"\x05token\x18\x02 \x01(\v2\x12.auth.v1.AuthTokenR\x05token\";\n" +
	"\x0eLogoutResponse\x12)\n" +
	"\x06status\x18\x01 \x01(\v2\x11.common.v1.StatusR\x06status2\xd3\x01\n" +
	"\vAuthService\x128\n" +
...
var file_auth_v1_auth_service_proto_goTypes = []any{
	...
	(*v1.Status)(nil),            // 5: common.v1.Status
	(*AuthToken)(nil),            // 6: auth.v1.AuthToken
	(*v11.UserProfile)(nil),      // 7: user.v1.UserProfile
	(*emptypb.Empty)(nil),        // 8: google.protobuf.Empty
}
var file_auth_v1_auth_service_proto_depIdxs = []int32{
	5, // 0: auth.v1.LoginResponse.status:type_name -> common.v1.Status
	6, // 1: auth.v1.LoginResponse.token:type_name -> auth.v1.AuthToken
	7, // 2: auth.v1.LoginResponse.user:type_name -> user.v1.UserProfile
	5, // 3: auth.v1.RefreshTokenResponse.status:type_name -> common.v1.Status
	6, // 4: auth.v1.RefreshTokenResponse.token:type_name -> auth.v1.AuthToken
	5, // 5: auth.v1.LogoutResponse.status:type_name -> common.v1.Status
	0, // 6: auth.v1.AuthService.Login:input_type -> auth.v1.LoginRequest
	2, // 7: auth.v1.AuthService.RefreshToken:input_type -> auth.v1.RefreshTokenRequest
	8, // 8: auth.v1.AuthService.Logout:input_type -> google.protobuf.Empty
	1, // 9: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	3, // 10: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.RefreshTokenResponse
