...
type ExecutionServiceClient interface {
	...
	StreamExecution(context.Context, *connect.Request[v1.StreamExecutionRequest]) (*connect.ServerStreamForClient[v1.WorkflowExecutionUpdate], error)
}
...
func NewExecutionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ExecutionServiceClient {
	...
	return &executionServiceClient{
		...
		streamExecution: connect.NewClient[v1.StreamExecutionRequest, v1.WorkflowExecutionUpdate](
			httpClient,
...
type executionServiceClient struct {
	...
	streamExecution *connect.Client[v1.StreamExecutionRequest, v1.WorkflowExecutionUpdate]
}
...
func (c *executionServiceClient) StreamExecution(ctx context.Context, req *connect.Request[v1.StreamExecutionRequest]) (*connect.ServerStreamForClient[v1.WorkflowExecutionUpdate], error) {
...
type ExecutionServiceHandler interface {
	...
	CancelExecution(context.Context, *connect.Request[v1.CancelExecutionRequest]) (*connect.Response[v1.CancelExecutionResponse], error)
	// Streams real-time updates for a running workflow.
	StreamExecution(context.Context, *connect.Request[v1.StreamExecutionRequest], *connect.ServerStream[v1.WorkflowExecutionUpdate]) error
}
...
func (UnimplementedExecutionServiceHandler) StreamExecution(context.Context, *connect.Request[v1.StreamExecutionRequest], *connect.ServerStream[v1.WorkflowExecutionUpdate]) error {
