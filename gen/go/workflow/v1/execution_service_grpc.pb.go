...
const (
	ExecutionService_StartExecution_FullMethodName  = "/workflow.v1.ExecutionService/StartExecution"
	ExecutionService_GetExecution_FullMethodName    = "/workflow.v1.ExecutionService/GetExecution"
	ExecutionService_ListExecutions_FullMethodName  = "/workflow.v1.ExecutionService/ListExecutions"
	ExecutionService_CancelExecution_FullMethodName = "/workflow.v1.ExecutionService/CancelExecution"
	ExecutionService_StreamExecution_FullMethodName = "/workflow.v1.ExecutionService/StreamExecution"
)
...
type ExecutionServiceClient interface {
	...
	StreamExecution(ctx context.Context, in *StreamExecutionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WorkflowExecutionUpdate], error)
}
...
func (c *executionServiceClient) StreamExecution(ctx context.Context, in *StreamExecutionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WorkflowExecutionUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[StreamExecutionRequest, WorkflowExecutionUpdate]{ClientStream: stream}
...
type ExecutionService_StreamExecutionClient = grpc.ServerStreamingClient[WorkflowExecutionUpdate]
...
type ExecutionServiceServer interface {
	...
	// Streams real-time updates for a running workflow.
	StreamExecution(*StreamExecutionRequest, grpc.ServerStreamingServer[WorkflowExecutionUpdate]) error
...
func (UnimplementedExecutionServiceServer) StreamExecution(*StreamExecutionRequest, grpc.ServerStreamingServer[WorkflowExecutionUpdate]) error {
...
func _ExecutionService_StreamExecution_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ExecutionServiceServer).StreamExecution(m, &grpc.GenericServerStream[StreamExecutionRequest, WorkflowExecutionUpdate]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ExecutionService_StreamExecutionServer = grpc.ServerStreamingServer[WorkflowExecutionUpdate]
...
var ExecutionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "workflow.v1.ExecutionService",
	...
	Metadata: "workflow/v1/execution_service.proto",
}
