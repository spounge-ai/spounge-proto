...
const (
	DashboardService_GetDashboard_FullMethodName = "/api.v2.DashboardService/GetDashboard"
)
...
var DashboardService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.v2.DashboardService",
	...
	Metadata: "api/v2/dashboard_service.proto",
}
